...
export default function RightNav () {
  return (
    <div id="top_icons" className="right_control">
      ...
      <button type="button" id="quick_add_task_holder" data-track="navigation|quick_add" aria-label="Quick Add" className="top_bar_btn" data-reach-tooltip-trigger="">
      ...
      <button type="button" id="top_completed_holder" data-track="navigation|karma" className="completed_pie_stat top_bar_btn">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <defs></defs>
          <g fill="none" fillRule="evenodd" transform="translate(3 3)">
            <mask id="4ZtaWA" fill="#fff">
              <path id="a" d="M12.3 5L7 10.3 5.4 8.6a.5.5 0 0 0-.8 0l-3.9 4a9 9 0 1 1 .5.9L5 9.7l1.6 1.7a.5.5 0 0 0 .8 0L13 5.7v3.8a.5.5 0 1 0 1 0v-5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.8z"></path>
            </mask>
            <g mask="url(#4ZtaWA)">
      ...
      <button type="button" aria-owns="notification_popup" aria-label="Notifications" aria-controls="notification_popup" aria-expanded="false" aria-haspopup="listbox" className="top_bar_btn">
        <svg width="24" height="24" viewBox="0 0 24 24">
          <g fill="none" fillRule="evenodd" transform="translate(4 3)">
